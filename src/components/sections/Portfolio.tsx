...
const gradients = [
  "linear-gradient(135deg, hsl(var(--cyan)), hsl(var(--teal)))",
  "linear-gradient(135deg, hsl(var(--purple)), hsl(var(--cyan)))",
  "linear-gradient(135deg, hsl(var(--orange)), hsl(var(--coral)))",
  "linear-gradient(135deg, hsl(var(--cyan)), hsl(var(--purple)))",
  "linear-gradient(135deg, hsl(var(--teal)), hsl(var(--orange)))",
  "linear-gradient(135deg, hsl(var(--purple)), hsl(var(--magenta)))",
];
        ...
        {!isLoading && (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {filteredProjects.map((project, index) => (
              ...
              >
              <div
                className="group rounded-2xl overflow-hidden glass hover:border-primary/30 transition-all duration-500 h-full"
              >
                {/* Project Image */}
                <div
