...
import { Trophy, Eye, Bot, Monitor, Award, Search } from "lucide-react";
...
const navItems = [
  ...
  { href: "/admin/it-solutions", label: "IT Solutions", icon: Monitor },
  { href: "/admin/why-choose-us", label: "Why Choose Us", icon: Award },
  { href: "/admin/community", label: "Community", icon: Users },
  { href: "/admin/community-meetings", label: "Community Meetings", icon: Trophy },
