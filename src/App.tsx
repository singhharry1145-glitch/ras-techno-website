...
import AdminITSolutions from "./pages/admin/AdminITSolutions";
import AdminWhyChooseUs from "./pages/admin/AdminWhyChooseUs";
import ScrollToTop from "./components/ScrollToTop";
import AdminCommunity from "./pages/admin/AdminCommunity";
// FloatingCommunityButton removed per request
import Community from "./pages/Community";
import AdminCommunityMeetings from "./pages/admin/AdminCommunityMeetings";
      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route path="/admin/it-solutions" element={<ProtectedRoute><AdminITSolutions /></ProtectedRoute>} />
            ...
            <Route path="/admin/community-meetings" element={<ProtectedRoute><AdminCommunityMeetings /></ProtectedRoute>} />
