  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "fade-in-up": "fade-in-up 0.8s cubic-bezier(.2,.8,.2,1) forwards",
        "scale-in": "scale-in 0.4s ease-out forwards",
        "slide-in-right": "slide-in-right 0.6s cubic-bezier(.2,.8,.2,1) forwards",
        "slide-in-left": "slide-in-left 0.6s cubic-bezier(.2,.8,.2,1) forwards",
